...
public class CursomcDebyApplication implements CommandLineRunner{
	...
	public static void main(String[] args) {
		SpringApplication.run(CursomcDebyApplication.class, args);
	}
	...
	public void run(String... args) throws Exception {
		...
		Produto p10 = new Produto(null, "Pendrive", 100.00);
		...
		Estado est2 = new Estado(null, "Sao Pauo");
